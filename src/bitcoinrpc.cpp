...
{
    return GetBoolArg("-testnet", false) ? 33317 : 33316;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop StreamCoin server (and possibly override the detachdb config value).");
...
void ThreadRPCServer(void* parg)
{
    ...
    RenameThread("streamcoin-rpclist");
...
void ThreadRPCServer3(void* parg)
{
    ...
    RenameThread("streamcoin-rpchand");
