...
static const uint256 hashGenesisBlock("0x00000a855e721047a9f401359fa2d9a013692fb1252dbe5cd582815469e501ab");
static const uint256 hashGenesisBlockTestNet("0x00000a855e721047a9f401359fa2d9a013692fb1252dbe5cd582815469e501ab");
...
public:
    ...
    {
        // streamcoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // streamcoin: get transaction coin age
...
public:
    ...
    // streamcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // streamcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // streamcoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // streamcoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // streamcoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // streamcoin: block index flags
    enum  
    {
