...
// Copyright (c) 2014-2015 The streamcoin developers
// Copyright (c) 2015 The StreamCoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("streamcoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("streamcoin-smsg-pow"); // Make this thread recognisable
