...
// streamcoin: total coins staked (non-spendable until maturity)
...
// streamcoin: check 'spent' consistency between wallet and txindex
// streamcoin: fix wallet spent state according to txindex
...
// streamcoin: disable transaction (only for coinstake)
